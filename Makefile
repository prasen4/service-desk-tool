.PHONY: help install dev test lint format serve clean frontend-install frontend-dev frontend-build
...
help:
	...
	@echo "  frontend-dev      Run the Vite dev server (proxies /api to :8080)"
	@echo "  frontend-build    Build the React app into src/tech_desk/api/web/dist"
